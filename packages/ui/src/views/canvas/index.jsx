...
// const connectionLineStyle = { stroke: 'linear-gradient(to right, #e084b4 100%, #77bfaf 50%)', strokeWidth: 3 }
// const connectionLineStyle = { stroke: '#121D35', strokeWidth: 3 }
// // stroke: 'linear-gradient(to bottom, #e084b4 0%, #77bfaf 100%)',
...
const Canvas = () => {
    ...
    const connectionLineStyle = {
        stroke: customization.isDarkMode ? '#E6EAF3' : '#121D35',
        strokeWidth: 3
    }
    ...
    // const testChatflowApi = useApi(chatflowsApi.testChatflow) current
    ...
    const onConnect = (params) => {
        ...
        // const connectionColor = sourceNode?.data?.color || '#121D35'
        const connectionColor = sourceNode?.data?.color || (customization.isDarkMode ? '#E6EAF3' : '#121D35')
        const connectionStrokeWidth = sourceNode?.data?.strokeWidth || 3

        const newEdge = {
            ...params,
            type: 'buttonedge',
            id: `${params.source}-${params.sourceHandle}-${params.target}-${params.targetHandle}`,
            style: { stroke: connectionColor, strokeWidth: connectionStrokeWidth }
        }
        ...
        (event) => {
            ...
            const newNode = {
                ...
                data: {
                    ...
                    color: customization.isDarkMode ? '#E6EAF3' : '#121D35',
                    strokeWidth: 3
                }
            }
    ...
    useEffect(() => {
        if (edges) {
            // Update connection line styles when node data changes
            const updatedEdges = edges.map((edge) => {
                const sourceNode = nodes.find((node) => node.id === edge.source)
                const connectionColor = customization.isDarkMode ? '#E6EAF3' : '#121D35'
                const connectionStrokeWidth = sourceNode?.data?.strokeWidth || 3
    ...
    }, [customization.isDarkMode, nodes, edges, setEdges])
            ...
            <Box>
                ...
                <Box
                    sx={{
                        ...
                        height: '100vh',
                        width: '100%',
                        backgroundColor: customization.isDarkMode ? '#121D35' : '#E6EAF3'
                    }}
                >
