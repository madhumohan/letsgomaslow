    ...
    return (
        <>
            ...
            {open ? (
                ...
                >
                    <IconMinus />
                    <p style={{ fontSize: '1rem', marginLeft: '5px' }}>Cancel</p>
                </StyledFab>
            ) : (
                <StyledFab
                    sx={{ left: 20, top: 20, width: '110px' }}
                ...
                >
                    <IconPlus />
                    <p style={{ fontSize: '1rem', marginLeft: '5px' }}>Add Node</p>
                </StyledFab>
            )}
            {/* {open ? <IconMinus /> : <IconPlus />}
                <p style={{ fontSize: "1rem" }}>Add Node</p> */}
            {/* </StyledFab> */}
            <Popper
                            ...
                            <ClickAwayListener onClickAway={handleClose}>
                                <MainCard border={false} elevation={16} content={false} boxShadow shadow={theme.shadows[16]}>
                                    ...
                                    <PerfectScrollbar
                                        ...
                                        // style={{ height: '100%', maxHeight: 'calc(100vh - 380px)', overflowX: 'hidden' }} current
                                        style={{
                                            height: '100%',
