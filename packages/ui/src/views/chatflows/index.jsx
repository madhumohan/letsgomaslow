        ...
        <MainCard sx={{ background: customization.isDarkMode ? theme.palette.common.black : '' }}>
            {error ? (
                ...
                <Stack flexDirection='column' sx={{ gap: 3 }}>
                    ...
                    {/* {!isLoading && (!view || view === 'card') && getAllChatflowsApi.data && ( current
                        <Grid container spacing={gridSpacing} gridTemplateColumns='repeat(3, 1fr)'>
                    ...
                    {/* {isLoading && !getAllChatflowsApi.data ? ( current
